      ...
      <View style={styles.outer}>
        <View style={styles.row}>
          <Pressable style={styles.item} onPress={() => navigation.navigate('Home')}>
            <Home size={24} color={isActive('Home') ? activeColor : inactiveColor} />
            <Text style={isActive('Home') ? styles.primaryText : styles.secondaryText}>Inicio</Text>
          </Pressable>

          <Pressable style={styles.item} onPress={() => navigation.navigate('Map')}>
            <MapPin size={24} color={isActive('Map') ? activeColor : inactiveColor} />
            <Text style={isActive('Map') ? styles.primaryText : styles.secondaryText}>Mapa</Text>
          </Pressable>
          ...
          <Pressable style={styles.item} onPress={() => navigation.navigate('Profile')}>
            <User size={24} color={isActive('Profile') ? activeColor : inactiveColor} />
            <Text style={isActive('Profile') ? styles.primaryText : styles.secondaryText}>Perfil</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
